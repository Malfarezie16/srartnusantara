  ...
  font-family: "Montserrat", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">SR_ART_NUSANTARA</div>
                <div class="masthead-heading text-uppercase">DAFTAR PERSEMBAHAN</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="#services">DISINI</a>
            </div>
        </header>
        <!-- Services-->
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">ENTERTEMENT OF</h2>
                    <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                        <h4 class="my-3">Acrobatic</h4>
                        <p class="text-muted"> penampilan luar biasa yang melibatkan keseimbangan, ketangkasan, dan kekuatan badan</p>
                    </div>
                    <div class="col-md-4">
                        <h4 class="my-3">Tari Tradisional</h4>
                        <p class="text-muted"> tarian yang berasal dari masyarakat suatu daerah yang sudah turun-temurun dan telah menjadi budaya masyarakat setempat.</p>
                    </div>
                    <div class="col-md-4">
                        <h4 class="my-3">Fire Dance</h4>
                        <p class="text-muted"> bentuk tarian yang merupakan ciptaan kaum muda yang menggunakan gerakan tari tradisional dan modern menggunakan alat yang ber api</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="team-member">
                            ...
                            <a class="btn btn-dark btn-social mx-2" href="https://www.instagram.com/sr_art_nusantara/" aria-label="Parveen Anand LinkedIn Profile"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-4">
